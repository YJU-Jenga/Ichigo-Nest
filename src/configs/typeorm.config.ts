...
export const TypeOrmConfig: TypeOrmModule = {
  ...
  password: 'mypassword',
  database: 'ichigo',
  entities: [Board, Calendar ,Cart, Comment, PurchaseOrder, Post, Product, User, CartToProduct, OrderToProduct, Device, Alarm, Music, Clothes, CartToProductOption, Models, OrderToProductOption], // Entity 연결
