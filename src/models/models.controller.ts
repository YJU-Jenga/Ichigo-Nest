...
export class ModelsController {
  ...
  async create(@UploadedFile() file: Express.MulterS3.File, @Body() dto: CreateModelsDto): Promise<void>{
  ...
  async update(@Param('id', ParseIntPipe) id:number, @UploadedFile() file: Express.MulterS3.File,  @Body() dto: UpdateModelsDto): Promise<void>{ // idが整数型なのか検証
